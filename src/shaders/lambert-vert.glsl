...
const float warpDisplacementMagnitude = 0.075;

void main()
{
    vec3 vertexPosition = vs_Pos.xyz;
    vec3 displacementDirection = vec3(vs_Pos.x, 0, vs_Pos.z);
    vertexPosition += displacementDirection * sin(u_Time + vs_Pos.y) * warpDisplacementMagnitude;
